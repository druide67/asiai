...
> **Nota:** Si tu agente se ejecuta dentro de Docker, `127.0.0.1` no es accesible. Usa la IP de red del host (por ejemplo, `192.0.2.10`) o `host.docker.internal` en Docker Desktop para Mac.
