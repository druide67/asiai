...
faq:
  - q: "What is asiai?"
    a: "asiai is an open-source CLI tool that benchmarks and monitors LLM inference engines on Apple Silicon Macs. It supports 10 engines (Ollama, LM Studio, mlx-lm, llama.cpp, oMLX, vllm-mlx, vMLX, Rapid-MLX, MTPLX, Exo) and measures tok/s, TTFT, power consumption, and VRAM usage."
...
asiai is an open-source CLI tool that benchmarks and monitors LLM inference engines on Apple Silicon Macs. It supports 10 engines (Ollama, LM Studio, mlx-lm, llama.cpp, oMLX, vllm-mlx, vMLX, Rapid-MLX, MTPLX, Exo) and measures tok/s, TTFT, power consumption, and VRAM usage with zero dependencies.
