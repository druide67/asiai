...
<div id="leaderboard-app" data-label-loading="加载中..." data-label-count="{n} 条结果" data-label-updated="更新时间：{t}" data-label-error="无法连接 api.asiai.dev" data-label-empty="未找到结果">
